  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error("Gagal membuat produk: " + text);
      }
    } catch (err) {
      console.error(err);
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 pt-2">
                  <input
                    ...
                    className="w-4 h-4 text-orange-600 border-slate-300 rounded focus:ring-orange-500 dark:bg-slate-800 dark:border-slate-700"
                  />
                  <label
                    htmlFor="featured"
