...
export function Footer() {
  ...
  return (
    <footer className="bg-white text-slate-600 pt-16 pb-8 border-t border-slate-200 mt-20 dark:bg-slate-900 dark:text-slate-300 dark:border-slate-800 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Brand Column */}
          <div className="space-y-6">
            <h3 className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter font-serif">
          ...
          <div className="border-b border-slate-200 dark:border-white/10 md:border-none pb-4 md:pb-0">
            <button
              ...
              className="w-full flex justify-between items-center md:hidden text-slate-900 dark:text-white font-semibold mb-2"
            >
            ...
            <h4 className="hidden md:block text-slate-900 dark:text-white font-semibold mb-6 tracking-wide uppercase text-xs">Akses Cepat</h4>
          ...
          <div className="border-b border-slate-200 dark:border-white/10 md:border-none pb-4 md:pb-0">
            ...
            <h4 className="hidden md:block text-slate-900 dark:text-white font-semibold mb-6 tracking-wide uppercase text-xs">Bantuan</h4>
          ...
          <div>
            <h4 className="text-slate-900 dark:text-white font-semibold mb-6 tracking-wide uppercase text-xs">Tetap Terhubung</h4>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-white border-none rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-orange-500 w-full transition-all placeholder:text-slate-500"
              />
        ...
        <div className="pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-500 font-medium">
