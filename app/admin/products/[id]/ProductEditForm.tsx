...
export default function ProductEditForm({ product }: { product: Product }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: We do not append "image" file here, as we relied on immediate upload.
  ...
  // Reconstructed from Remote logic to handle featured toggle via button
  const handleSetFeatured = async () => {
    try {
      ...
      // Append other fields to ensure they aren't wiped or validation passes
      fd.append("name", form.name);
      fd.append("slug", form.slug);
      fd.append("category", form.category);
      fd.append("description", form.description);
      ...
      // Check if image file was newly selected but not uploaded (shouldn't happen with immediate upload, but just in case)
      if (imageFile) {
        // With immediate upload, form.imageUrl is the Source of Truth.
        // We do NOT send the file again unless we want the backend to re-process it.
        // So we skip appending 'image' file here and trust 'imageUrl'.
      }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              {/* Inject Upload Progress Bar */}
              {uploadProgress > 0 && (
                <div style={{ width: "100%", maxWidth: 320, display: "flex", flexDirection: "column", gap: 4, margin: "0 auto" }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: "100%",
                        background: uploadProgress === 100 ? "#22c55e" : "#f97316",
